        ...
        if ($this->auth->check()) {
            Menu::register('user', [
                Menu::dropdown([
                    ...
                    Menu::link('profile.index', '<i class="fa fa-user" aria-hidden="true"></i> ' . __('common.nav.profile'), [], [], ['profile.edit_password', 'profile.edit_email', 'profile.confirm_new_email']),
